...
const LoginPage = () => {
  const [usernameTextInputIsActive, setUsernameTextInputIsActive] =
    useState(false);
  const [passwordTextInputIsActive, setPasswordTextInputIsActive] =
    useState(false);
        ...
        <View>
          ...
          <View
            style={[
              ...
              {borderColor: usernameTextInputIsActive ? '#F2CF4B' : '#11181E'},
            ]}>
          ...
          <View
            style={[
              styles.textInputContainer,
              {
                borderColor: passwordTextInputIsActive ? '#F2CF4B' : '#11181E',
                marginTop: 15,
              },
            ]}>
